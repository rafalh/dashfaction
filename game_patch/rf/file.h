...
namespace rf
{
    ...
    static auto& VPackfileAdd = AddrAsRef<int(const char *file_name, const char *dir)>(0x0052C070);
    static auto& VPackfileSetLoadingUserMaps = AddrAsRef<void(bool loading_user_maps)>(0x0052BB50);
