...
namespace df::gr::d3d11
{
    ...
    ComPtr<ID3D11ShaderResourceView> TextureManager::create_texture(bm::Format fmt, int w, int h, ubyte* bits, ubyte* pal)
    {
    ...
    ComPtr<ID3D11ShaderResourceView> TextureManager::create_texture(int bm_handle)
    {
    ...
    int TextureManager::lock(int bm_handle, int section, gr::LockInfo *lock, int mode)
    {
