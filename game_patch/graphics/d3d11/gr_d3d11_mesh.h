...
namespace df::gr::d3d11
{
    ...
    public:
        ...
        {
            Batch(
                int start_index, int num_indices, int base_vertex, int texture_index, rf::gr::Mode mode,
                bool double_sided
            ) :
        ...
        BaseMeshRenderCache(rf::VifLodMesh* lod_mesh) : lod_mesh_(lod_mesh) {}
    ...
    private:
        void draw_cached_mesh(
            rf::VifLodMesh* lod_mesh, const BaseMeshRenderCache& render_cache, const rf::MeshRenderParams& params,
            int lod_index
        );
