...
{
public:
    D3D11ShaderManager(ComPtr<ID3D11Device> device);
    void bind_default_shaders(D3D11RenderContext& render_context);
    void bind_character_shaders(D3D11RenderContext& render_context);
