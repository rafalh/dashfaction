...
namespace df::gr::d3d11
{
    ...
    template<>
    inline std::vector<D3D11_INPUT_ELEMENT_DESC> VertexLayoutTrait<VertexLayout::standard>::get_desc()
    {
        return {
    ...
    template<>
    inline std::vector<D3D11_INPUT_ELEMENT_DESC> VertexLayoutTrait<VertexLayout::character>::get_desc()
    {
        return {
            {"POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0
            },
    ...
    template<>
    inline std::vector<D3D11_INPUT_ELEMENT_DESC> VertexLayoutTrait<VertexLayout::transformed>::get_desc()
    {
        return {
            {"POSITIONT", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, D3D11_APPEND_ALIGNED_ELEMENT,
             D3D11_INPUT_PER_VERTEX_DATA, 0},
            {"COLOR", 0, DXGI_FORMAT_R8G8B8A8_UNORM, 0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0},
