...
static const char* gr_d3d11_error_code_name(HRESULT hr)
{
    switch (hr) {
...
void gr_d3d11_error(HRESULT hr, const char* fun)
{
    ...
    const char* code_name = gr_d3d11_error_code_name(hr);
    ...
    if (hr == DXGI_ERROR_DEVICE_REMOVED) {
        ...
        hr = gr_d3d11_get_device_removed_reason();
        code_name = gr_d3d11_error_code_name(hr);
