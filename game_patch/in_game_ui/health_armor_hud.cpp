    ...
    [](rf::Player *player) {
        ...
        if (rf::entity_is_attached_to_vehicle(entity)) {
            ...
            if (rf::entity_is_jeep_driver(entity) || rf::entity_is_jeep_shooter(entity)) {
                ...
                auto [jeep_value_x, jeep_value_y] = hud_scale_coords(rf::hud_points[rf::hud_jeep_value], scale);
                ...
                auto veh_life_str = std::to_string(veh_life);
                rf::gr_set_color(rf::hud_full_color);
                auto [driller_value_x, driller_value_y] = hud_scale_coords(rf::hud_points[rf::hud_driller_value], scale);
            ...
            auto [health_x, health_y] = hud_scale_coords(rf::hud_points[rf::hud_health], scale);
            ...
            auto [envirosuit_x, envirosuit_y] = hud_scale_coords(rf::hud_points[rf::hud_envirosuit], scale);
            ...
            auto [health_value_x, health_value_y] = hud_scale_coords(rf::hud_points[rf::hud_health_value_ul_corner], scale);
            auto health_value_w = hud_scale_coords(rf::hud_points[rf::hud_health_value_width_and_height], scale).x;
            ...
            auto [envirosuit_value_x, envirosuit_value_y] = hud_scale_coords(rf::hud_points[rf::hud_envirosuit_value_ul_corner], scale);
            auto envirosuit_value_w = hud_scale_coords(rf::hud_points[rf::hud_envirosuit_value_width_and_height], scale).x;
            ...
            if (rf::entity_is_holding_body(entity)) {
                ...
                auto [corpse_icon_x, corpse_icon_y] = hud_scale_coords(rf::hud_points[rf::hud_corpse_icon], scale);
                hud_scaled_bitmap(rf::hud_body_indicator_bmh, corpse_icon_x, corpse_icon_y, scale, state);
                rf::gr_set_color(rf::hud_body_color);
                auto [corpse_text_x, corpse_text_y] = hud_scale_coords(rf::hud_points[rf::hud_corpse_text], scale);
...
void hud_status_set_big(bool is_big)
{
    ...
    rf::hud_health_enviro_font = rf::gr_load_font(is_big ? "bigfont.vf" : "smallfont.vf");
